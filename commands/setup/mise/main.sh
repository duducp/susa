...
show_complement_help() {
    ...
    log_output "  mise install go@1.15.6	    # Instalar uma versao específica do Go"
    log_output "  mise use --global go@1.25.6  	# Instalar e usar Go 1.25.6 como versão padrão do sistema"
    log_output "  mise use go@1.25.6 			# Usar Go 1.25.6 no diretório atual"
